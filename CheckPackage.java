...
public class CheckPackage extends JFrame{
    ...
    public JPanel createPackage(String[] pack){
        ...
        lblName_1.setBounds(35, 190, 300, 20);
        ...
        lblReserveRoomNumber.setBounds(35, 310, 300, 14);
        lblReserveRoomNumber.setFont(new Font ("Tahoma",Font.BOLD,18));        
